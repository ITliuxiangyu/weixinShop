angular.module("starter.shoppingCart",[])
    ...
    .controller("shoppingCartController",function ($scope,$rootScope,$state,$ionicPopup,$timeout,HttpFactory) {
                    ...
                    onTap:function (e) {
                        ...
                        HttpFactory.getData("/api/ushoppingCart",params,"DELETE").then(function (result) {
                            ...
                            if (result.status == 0) {
                                ...
                                $scope.popTipShow("删除成功");
                            }else {
                                $scope.popTipShow("删除失败");
                            }
                        },function (err) {

                            $scope.popTipShow("获取数据失败");
                        });
